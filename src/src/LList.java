...
// traverse the chain to locate the desired node
    ...
    */  
    ...
    public boolean removeSecond(T anEntry) {
        ...
        Node curreNode = firstNode;
        while (curreNode != null){
            if(curreNode.equals(anEntry) && found){ //This means that we have already came across this node
                remove(postion);
                return found;
            } else if (curreNode.equals(anEntry) && found == false){ //Our first time coming acoss the node
                found = true;
            }
